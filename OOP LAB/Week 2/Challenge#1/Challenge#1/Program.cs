...
namespace Challenge_1
{
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                else if (choice == "2")
                {
                    ...
                    {
                        Console.WriteLine("Index \t\t Name \t\t Matric Marks \t\t Fsc Marks \t\t ECAT Marks");// this shows the students detail
                        for (int i=0; i<studentCounter; i++)
                        {
                            studentDetails[i].showStudents(i);
                        }
                    }
                    returnforAll();
                ...
                else if (choice == "3")
                {
                    ...
                    else
                    {
                        for (int i = 0; i < studentCounter; i++)
                        {
                            studentDetails[i].aggregate = studentDetails[i].calculateAggregate(); ;
                        }

                        Console.WriteLine("Index \t\t Name \t\t Aggegrate");
                        for(int i = 0; i<studentCounter; i++)
                        {
                            studentDetails[i].showAggregate(i);
                        }
                    }
                    returnforAll();
        ...
        class Student
    {
        ...
        {
            float agg = ((0.25F * matricMarks / 1100) + (0.45F * fscMarks / 1100) + (0.30f * ecatMarks / 400)) * 100;
            return agg;
            
        }

        public void showAggregate(int i)
        {
            
            
            
                Console.WriteLine((i + 1) + "\t\t" + sname + "\t\t\t" + aggregate);
        ...
        public void showStudents(int i)
        {
                ...
                Console.WriteLine((i + 1) + "\t\t" + sname + "\t\t\t" + matricMarks + "\t\t\t" + fscMarks + "\t\t\t" + ecatMarks);
